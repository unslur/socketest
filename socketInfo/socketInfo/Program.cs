...
namespace socketInfo
{
    class Program
    {
        ...
        private static void ReceiveMessage(object clientSocket)
        {
            ...
            byte[] finishmakerm = new byte[18] { 0x02, 0x00, 0x7e, 0x00, 0x44, 0x00, 0x56, 0x00, 0x30, 0x00, 0x7c, 0x00, 0x30, 0x00, 0x7c, 0x00, 0x03, 0x00 };
            Socket myClientSocket = (Socket)clientSocket;
            byte[] finishwdj = new byte[6] { 0x50,0x50,0x52,0x52,0x53,0x00};
            string data = "sjc";
            int i = 0;
            int receiveNumber = 0;
